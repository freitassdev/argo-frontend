...
export function FileDropzone() {
  ...
  return (
    <div className="h-60 w-full">
      <motion.div
        className={`relative size-full flex flex-col items-center justify-center cursor-pointer rounded-xl border-2 border-dashed p-12 text-center transition-colors ${
          isDragActive
